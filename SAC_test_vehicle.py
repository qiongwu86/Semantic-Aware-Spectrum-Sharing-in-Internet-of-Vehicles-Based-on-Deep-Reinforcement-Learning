...
label1 = 'model/sac_model/with_sc_n_veh_16_lamda0.9_lr3e-4_hs_512_bs64_newpowerlist'
        ...
        for test_step in range(n_step_per_episode1):
            ...
            for i in range(n_RB):
                for j in range(n_neighbor):
                    ...
                    test_action_all_training1[i, j, 1] = ((action1[1 + i * 2] + 1) / 2) * 4  # power selected by PL
            for i in range(n_RB):
