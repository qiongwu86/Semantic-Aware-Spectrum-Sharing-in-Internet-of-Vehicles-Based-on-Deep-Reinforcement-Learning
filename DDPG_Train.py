...
label = 'model/ddpg_model/vehicle8_newpowerlist_lamda0.9_bs64_alpha_0.001_bata0.001'
...
if IS_TRAIN:
    ...
    np.save('Data/vehicle8_newpowerlist_lamda0.9_bs64_alpha_0.001_bata0.001.npy', reward_average_list)
